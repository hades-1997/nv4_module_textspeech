...
<link href="{NV_STATIC_URL}{NV_ASSETS_DIR}/css/aplayer/APlayer.min.css" rel="stylesheet">
<script src="{NV_STATIC_URL}{NV_ASSETS_DIR}/js/aplayer/APlayer.min.js" type="text/javascript"></script>
